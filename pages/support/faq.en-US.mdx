...
We build Dataverse Wallet to assume control of a series of operations like creating data streams, adding access control modules, monetizing into on-chain
assets and so on.
...
You can use `Dataverse Connector` SDK in nextjs, but note that the SDK needs to communicate with the browser extension `Dataverse Wallet`,
