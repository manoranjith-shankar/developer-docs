...
Dataverse Wallet is a Chrome browser extension. We need to make sure it's installed and
...
By default, leave the `profileId` as `null`, and the transaction will go through dataverse default profileless smart contracts.
