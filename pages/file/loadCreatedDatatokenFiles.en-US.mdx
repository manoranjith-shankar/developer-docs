...
Get a list of files which has been created as a data token.
...
<Callout>
  ...
  the files which has been created as a data token under this DID.
</Callout>
...
```json
{
  "kjzl6kcym7w8y8nftjplrm12dwy2uraluh6otswxporhmfukx1cythmnyfrimnf": {
    "content": {
      "text": "hello",
      "images": [
  ...
  "kjzl6kcym7w8y8dhk0rihz71kvnrk3anvwafy10ef6pwf6v7bdunqrsthj0c3fb": {
    ...
  },
  ...
}
