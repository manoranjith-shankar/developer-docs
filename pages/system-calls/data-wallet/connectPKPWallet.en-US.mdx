...
Connet to a [Lit PKP](https://developer.litprotocol.com/pkp/intro) wallet.
...
<Callout>
To try Lit PKP, visit the [LIT faucet](https://faucet.litprotocol.com/) to claim LIT Test tokens.
Then, mint a PKP [here](https://explorer.litprotocol.com/mint-pkp).
</Callout>


## Usage
```js
await runtimeConnector.connectPKPWallet()
```
