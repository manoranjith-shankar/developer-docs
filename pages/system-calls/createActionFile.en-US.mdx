...
- OPTIONAL - `folderId`: `string` - the id of the target folder to put the action file in, if not specified, the action file will be put in the default folder declared in `create-dataverse-app`.
