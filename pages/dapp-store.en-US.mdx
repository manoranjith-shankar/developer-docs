...
Applications built over DApp Store conform to the same set of data schemas (defined as _**Files**_ in DataverseOS).
...
dReadwise(Web3 version of Readwise) is a bookmarking app and Arazzo is for taking notes. With the shared data schema, Arazzo can let users reference their highlighted snippets from dRaindrop when creating notes in Arazzo.
