...
Execute [Lit Actions](https://developer.litprotocol.com/learninglab/intro-to-lit/prog-signing/#lit-actions) through our SDK.
...
For a detailed introduction to Lit Actions parameters, please refer to the [Lit Actions documentation](https://developer.litprotocol.com/learninglab/intro-to-lit/prog-signing/#lit-actions).
