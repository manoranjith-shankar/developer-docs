...
DataverseOS offers mechanisms to create and manage personal identities, such as wallet address and [PKH DID](https://developers.ceramic.network/docs/advanced/standards/accounts/pkh-did/).
These identities are designed to be secure and enable users to retain control over their digital presence.

### Decentralized Storage

The operating system utilizes IPFS (InterPlanetary File System) as storage provider.
