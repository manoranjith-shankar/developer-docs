...
DataverseOS is the **next-generation personal computer** owned by your wallet.
It is an **Internet Data Operating System** that manages online data for users and eases development of sovereign data dApps.

DataverseOS is built on top of decentralized web stacks, aimed at reshaping today's internet to forge a Web3 data paradigm - data computed by dApps, stored in personal cloud, sovereigned by users and protected by wallets.
...
DataverseOS compresses the complexity of building data dApps with a simple and easy-to-use SDK.
...
- **Dataverse Cloud** - User-centric storage fully owned by your identity. A cloud drive to store, visualize and monetize all data assets.

- **Dataverse Wallet** - A crypto wallet managing both token & data assets.
